...
def upgrade():
    ...
    op.create_index(op.f('ix_measurements_id'), 'measurements', ['id'], unique=False, schema=schema)
    op.create_index(op.f('ix_measurements_user_id'), 'measurements', ['user_id'], unique=False, schema=schema)
    op.create_index(op.f('ix_measurements_aquarium_id'), 'measurements', ['aquarium_id'], unique=False, schema=schema)
    op.create_index(op.f('ix_measurements_parameter_type'), 'measurements', ['parameter_type'], unique=False, schema=schema)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_measurements_id'), table_name='measurements', schema=schema)
